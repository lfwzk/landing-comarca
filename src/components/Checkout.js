    ...
    <div className="font-exo">
      <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-center flex-nowrap font-exo ">
        <a
          ...
          href="/services"
          className="flex items-center py-3 text-comarcaBlack"
        >
          <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="bg-gray-50 py-12 md:py-24">
              {cart
                ...
                .map((space) => (
                  <div key={space.id} className="mx-auto max-w-lg px-4 lg:px-8">
                    <div className="flex items-center">
                      <h2 className="ml-4 font-medium">{space.title}</h2>
                    </div>
