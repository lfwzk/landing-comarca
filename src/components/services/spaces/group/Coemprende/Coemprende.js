    ...
    <div>
      ...
      <section className="py-6 bg-white text-gray-900">
        <div className="container max-w-7xl mx-1 px-1 lg:pt-8">
          ...
          <h1 className="text-4xl font-exo font-bold p-8">Co Emprende</h1>
        </div>
      ...
      <section className="py-6 bg-gray-100 text-gray-900 font-exo">
        <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
          <div className="py-6 md:py-0 md:px-6">
            <h1 className="text-4xl font-bold p-3">Co Emprende </h1>
            <h2 className="text-2xl font-bold">Descripción </h2>
            <p className="pt-2 pb-4 text-justify">
              Un espacio de reuniones corporativas e institucionales para
              empresas, enfocado al trabajo organizacional y actividades
              grupales multidisciplinarias en un ambiente equipado con accesos a
            ...
            <ul className="list-disc list-inside">
              <li>Sala de juntas de ocho (8) a catorce (14) personas</li>
              <li>Internet Ilimitado 120 MB de velocidad Red Lan</li>
              <li>TV + HDMI</li>
              <li>Tv cable</li>
              <li>Ecram</li>
              <li>Pizarras</li>
