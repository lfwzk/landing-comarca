    ...
    <>
      ...
      <section className="py-6 bg-white text-gray-900">
        <div className="container max-w-7xl mx-1 px-1 lg:pt-8">
          ...
          <h1 className="text-4xl font-exo font-bold p-8">Team Emprendedor </h1>
        </div>
      </section>
      <section className="py-6 bg-gray-100 text-gray-900 font-exo">
        <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
          <div className="py-6 md:py-0 md:px-6">
            <h1 className="text-4xl font-bold p-3">Team Emprendedor </h1>
            <h2 className="text-2xl font-bold">Descripción </h2>
            <p className="pt-2 pb-4 text-justify">
              Un espacio de trabajo confortable para un equipo de cinco (5)
              personas con acceso a herramientas de trabajo{" "}
              <strong className="text-comarcaYellow">¡all inclusive¡</strong>{" "}
              ideal para crear sinergias con empresas y profesionales
              independientes de diversas áreas.
            </p>
            <h2 className="text-2xl font-bold">Características</h2>

            <ul className="list-disc list-inside">
              <li>
                Mesas de trabajo en área compartida exclusiva con casilleros.
              </li>
              ...
              <li>Acceso a sala de juntas libres 5 hrs. mensual</li>
